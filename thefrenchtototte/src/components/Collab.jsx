			...
			<div className='flex flex-wrap min-[1100px]:flex-nowrap justify-center gap-16 mt-16'>
				...
				<div>
					<Person
						...
						text={
							<>
								Grâce à <b className='font-tartuffo text-brown-dark'>the french tototte®</b> je régule
								mon taux d’insuline parfaitement et je n’achète plus de saumon ni de nutella !
							</>
						}
					/>
				</div>
