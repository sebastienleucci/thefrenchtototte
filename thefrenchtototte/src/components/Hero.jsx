	...
	return (
		<section className='flex flex-col'>
			<div className='relative flex justify-center w-[100dvw]'>
				...
				<div className='absolute z-10 bottom-0 left-6 translate-x-1/2 w-[2px] h-1/2 mx-auto bg-gradient-to-t from-beige/30 to-transparent' />
				<div className='absolute z-10 bottom-0 right-6 -translate-x-1/2 w-[2px] h-1/2 mx-auto bg-gradient-to-t from-beige/30 to-transparent' />
			</div>
